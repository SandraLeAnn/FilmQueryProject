...
public class Film {
	...
	public Film(int id, String title, String description, int release_year, int language_id, int rental_duration,
			double rental_rate, int length, double replacement_cost, String rating, String special_features, List<Actor> actors, String languageName) {
		super();
		this.id = id;
		this.title = title;
	...
	public String toString() {
		return "Film [id=" + id + ", title=" + title + ", description=" + description + ", release_year=" + release_year
				...
				+ ", special_features=" + special_features + ", actors=" + actors + ", languageName=" + languageName
				+ "]";
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(description, other.description) && id == other.id && language_id == other.language_id
				...
				&& rental_duration == other.rental_duration && rental_rate == other.rental_rate
				&& replacement_cost == other.replacement_cost
